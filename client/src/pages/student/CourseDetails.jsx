      ...
      <div className='absolute top-0 left-0 w-full h-section-height -z-1 bg-gradient-to-b from-cyan-100/70'></div>
          ...
          <div className='max-w-xl z-10 text-gray-500'>
            ...
            <p className='pt-4 md:text-base text-sm' dangerouslySetInnerHTML={{__html : courseData.courseDescription.slice(0,200)}}></p>
             ...
             <div className='flex items-center space-x-2 pt-3 pb-3 text-sm'>
                     ...
                     <p className='text-sm '>Course by <span className='text-blue-600 underline'>Teacher's Academy</span></p>
...

         {
          ...
          <div className='p-5 '>
            ...
            <button className='md:mt-6 mt-4 w-full py-3 rounded bg-blue-600 text-white font-medium'>{ isAlreadyEnrolled ? 'Enrolled' : 'Enroll Now'}</button>
            <div className='pt-6'>
