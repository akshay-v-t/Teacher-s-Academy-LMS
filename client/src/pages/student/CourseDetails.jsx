      ...
      <div className='absolute top-0 left-0 w-full h-section-height -z-1 bg-gradient-to-b from-cyan-100/70'></div>
            ...
            <p className='pt-4 md:text-base text-sm' dangerouslySetInnerHTML={{__html : courseData.courseDescription.slice(0,200)}}></p>
             ...
             <div className='flex items-center space-x-2 pt-3 pb-3 text-sm'>
                       ...
                       <div className='flex'>
                         {
                           [...Array(5)].map((_, i)=> (
                             <img key={i} src={i<Math.floor(calculateRating(courseData))? assets.star: assets.star_blank} className='w-3.5 h-3.5' alt=''/>
                           ))
                         }
                       </div>
                     ...
                     <p className='text-sm '>Course by <span className='text-blue-600 underline'>{courseData?.educator?.name || "Unknows Educator"}</span></p>
                     ...
                     <div className='py-20 text-sm md:text-default'>
                      ...
                      <p className='pt-3 rick-text' dangerouslySetInnerHTML={{__html : courseData.courseDescription}}></p>
                     </div>
...

         {
                playerData ?  <YouTube videoId={playerData.videoId} opts={{playerVars: {
                  autoplay: 1 }}} iframeClassName='w-full aspect-video'/> : <img src={courseData.courseThumbnail} alt="Course Thumbnail" />
              }
          ...
          <div className='p-5 '>
            ...
            <button onClick={enrollCourse} className='md:mt-6 mt-4 w-full py-3 rounded bg-blue-600 text-white font-medium'>{ isAlreadyEnrolled ? 'Enrolled' : 'Enroll Now'}</button>
            <div className='pt-6'>
